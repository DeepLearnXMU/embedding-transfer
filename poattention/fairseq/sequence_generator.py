...
class SequenceGenerator(nn.Module):
    ...
    def update_dict(self, new_tgt_dict):
        self.tgt_dict = new_tgt_dict
        self.vocab_size = len(new_tgt_dict)
        self.search = search.BeamSearch(new_tgt_dict)
    ...
    def _generate(
        ...
        target_chld_prt_tokens = net_input['target_chld_prt_tokens']
        target_types = net_input['target_types']
        target_positions = net_input['target_positions']
    ...
    def forward_decoder(
        ...
        for i, model in enumerate(self.models):
            ...
            if self.has_incremental_states():
                ...
                decoder_out = model.decoder.forward(tokens, target_chld_prt_tokens, target_types, target_positions, encoder_out=encoder_out)
