...
# import ...models.bert.modeling_bert.BertLayer

class EmbeddingGenerator(nn.Module):
    def __init__(self, config, embed_tokens, gather_padding_index, padding_idx):
    ...
    def forward(self, chld_prt_tokens, types, positions):
        ...
        this_token_embs = self.embed_positions(positions)
